...
void build_vnHistograms_version14_pt(std::string datalist = "", std::string outputfile = ""){
...
TH1D *aux_hist_Q2Q2Q2Q2_HFmHFmHFpHFp = new TH1D("aux_hist_Q2Q2Q2Q2_HFmHFmHFpHFp","",500,-0.0005,0.0005);//20000,-1000000,1000000
...
TH2D *aux_Q2Q2_D0D0barHF_centbin_pTbin_ybin_massbin = new TH2D("aux_Q2Q2_D0D0barHF_centbin_pTbin_ybin_massbin","",N_MASSBIN,massbinning,10000,-0.2,0.2);//400,-200,200
...
TH2D *aux_Q2Q2Q2Q2_D0D0barHFHFHF_centbin_pTbin_ybin_massbin = new TH2D("aux_Q2Q2Q2Q2_D0D0barHFHFHF_centbin_pTbin_ybin_massbin","",N_MASSBIN,massbinning,10000,-0.01,0.01);
            ...
            if( (min_centbin[i_centbin]<=centrality && centrality<max_centbin[i_centbin]) && 
              ...
              if(flavor[i]>0){
                ...
                if(y[i]>0){
                  ...
                  hist_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin*1./HFsumETMinus);
                  hist_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin*1./HFsumETMinus);
                  hist_Q2Q2_D0plusD0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin*1./HFsumETMinus);
                  hist_Q2Q2_D0plusD0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin*1./HFsumETMinus);   
                  ...
                  hist_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)));
                  hist_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)));   
                  ...
                  hist_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)));
                  hist_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)));   
                ...
                if(y[i]>0){
                  ...
                  hist_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin*1./HFsumETMinus);
                  hist_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin*1./HFsumETMinus);
                  hist_Q2Q2_D0plusD0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin*1./HFsumETMinus);
                  hist_Q2Q2_D0plusD0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin*1./HFsumETMinus);
                  ...
                  hist_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)));
                  hist_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)));   
                  ...
                  hist_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin*1./HFsumETPlus);
                  hist_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin*1./HFsumETPlus);
                  hist_Q2Q2_D0plusD0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin*1./HFsumETPlus);       
                  hist_Q2Q2_D0plusD0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin*1./HFsumETPlus);
                  ...
                  hist_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)));
                  hist_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)));   
