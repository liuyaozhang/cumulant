...
void build_vnHistograms_version12_pt(std::string datalist = "", std::string outputfile = ""){
...
TH1D *aux_hist_Q2Q2_HFmHFp = new TH1D("aux_hist_Q2Q2_HFmHFp","",500,-0.06,0.06);//60000,-30000,30000

TH1D *hist_Q2Q2_HFmTrk_Re_centbin[N_CENTBIN];//centrality
TH1D *hist_Q2Q2_HFmTrk_Im_centbin[N_CENTBIN];//centrality
TH1D *aux_hist_Q2Q2_HFmTrk = new TH1D("aux_hist_Q2Q2_HFmTrk","",500,-0.06,0.06);

TH1D *hist_Q2Q2_HFpTrk_Re_centbin[N_CENTBIN];//centrality
TH1D *hist_Q2Q2_HFpTrk_Im_centbin[N_CENTBIN];//centrality
TH1D *aux_hist_Q2Q2_HFpTrk = new TH1D("aux_hist_Q2Q2_HFpTrk","",500,-0.06,0.06);
...
TH1D *aux_hist_Q2Q2Q2Q2_HFmHFmHFpHFp = new TH1D("aux_hist_Q2Q2Q2Q2_HFmHFmHFpHFp","",500,-0.00002,0.00002);//20000,-1000000,1000000
...
TH2D *aux_Q2Q2_D0D0barHF_centbin_pTbin_ybin_massbin = new TH2D("aux_Q2Q2_D0D0barHF_centbin_pTbin_ybin_massbin","",N_MASSBIN,massbinning,500,-0.2,0.2);//400,-200,200
...
TH2D *aux_Q2Q2Q2Q2_D0D0barHFHFHF_centbin_pTbin_ybin_massbin = new TH2D("aux_Q2Q2Q2Q2_D0D0barHFHFHF_centbin_pTbin_ybin_massbin","",N_MASSBIN,massbinning,500,-0.001,0.001);
...
for(Long64_t ii=0; ii<n_entries; ii++){//loop in events
  ...
  for(Int_t i=0; i<N_CENTBIN; i++){
    if(min_centbin[i]<=centrality && centrality<max_centbin[i]){
       ...
       hist_Q2Q2_HFmHFp_Re_centbin[i]->Fill(aux_Q2Q2_HFmHFp_Re * 1./(HFsumETMinus*HFsumETPlus), HFsumETMinus*HFsumETPlus);
       hist_Q2Q2_HFmHFp_Im_centbin[i]->Fill(aux_Q2Q2_HFmHFp_Im * 1./(HFsumETMinus*HFsumETPlus), HFsumETMinus*HFsumETPlus);
       hist_Q2Q2_HFmTrk_Re_centbin[i]->Fill(aux_Q2Q2_HFmTrk_Re * 1./(HFsumETMinus*HFsumETPlus), HFsumETMinus*HFsumETPlus);
       hist_Q2Q2_HFmTrk_Im_centbin[i]->Fill(aux_Q2Q2_HFmTrk_Im * 1./(HFsumETMinus*HFsumETPlus), HFsumETMinus*HFsumETPlus);
       hist_Q2Q2_HFpTrk_Re_centbin[i]->Fill(aux_Q2Q2_HFpTrk_Re * 1./(HFsumETMinus*HFsumETPlus), HFsumETMinus*HFsumETPlus);
       hist_Q2Q2_HFpTrk_Im_centbin[i]->Fill(aux_Q2Q2_HFpTrk_Im * 1./(HFsumETMinus*HFsumETPlus), HFsumETMinus*HFsumETPlus);
    
       //cout << "aux_Q2Q2_HFmHFp_Re * 1./(HFsumETMinus*HFsumETPlus"<< "=" << aux_Q2Q2_HFmHFp_Re * 1./(HFsumETMinus*HFsumETPlus) << endl; 
       //cout << "aux_Q2Q2_HFmTrk_Re * 1./(HFsumETMinus*HFsumETPlus"<< "=" << aux_Q2Q2_HFmTrk_Re * 1./(HFsumETMinus*HFsumETPlus) << endl; 
       ...
       hist_Q2Q2Q2Q2_HFmHFmHFpHFp_Re_centbin[i]->Fill(aux_Q2Q2Q2Q2_HFmHFmHFpHFp_Re * 1./(HFsumETMinus*(HFsumETMinus-1)*HFsumETPlus*(HFsumETPlus-1)), (HFsumETMinus*(HFsumETMinus-1)*HFsumETPlus*(HFsumETPlus-1)));
       hist_Q2Q2Q2Q2_HFmHFmHFpHFp_Im_centbin[i]->Fill(aux_Q2Q2Q2Q2_HFmHFmHFpHFp_Im * 1./(HFsumETMinus*(HFsumETMinus-1)*HFsumETPlus*(HFsumETPlus-1)), (HFsumETMinus*(HFsumETMinus-1)*HFsumETPlus*(HFsumETPlus-1)));


      //cout << "aux_Q2Q2Q2Q2_HFmHFmHFpHFp_Re * 1./(HFsumETMinus*(HFsumETMinus-1)*HFsumETPlus*(HFsumETPlus-1))"<< " = "<<aux_Q2Q2Q2Q2_HFmHFmHFpHFp_Re * 1./(HFsumETMinus*(HFsumETMinus-1)*HFsumETPlus*(HFsumETPlus-1)) <<endl; 
    }     
  }  
            ...
            if( (min_centbin[i_centbin]<=centrality && centrality<max_centbin[i_centbin]) && 
              ...
              if(flavor[i]>0){
                ...
                if(y[i]>0){
                  ...
                  hist_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin*1./HFsumETMinus, HFsumETMinus);
                  hist_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin*1./HFsumETMinus, HFsumETMinus);
                  hist_Q2Q2_D0plusD0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin*1./HFsumETMinus, HFsumETMinus);
                  hist_Q2Q2_D0plusD0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin*1./HFsumETMinus, HFsumETMinus);   
                  ...
                  hist_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)), HFsumETPlus*HFsumETMinus*(HFsumETMinus-1));
                  hist_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)), HFsumETPlus*HFsumETMinus*(HFsumETMinus-1));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)), HFsumETPlus*HFsumETMinus*(HFsumETMinus-1));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)), HFsumETPlus*HFsumETMinus*(HFsumETMinus-1));   
                  ...
                  hist_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i], aux_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin*1./HFsumETPlus, HFsumETPlus);
                  hist_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i], aux_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin*1./HFsumETPlus, HFsumETPlus);
                  hist_Q2Q2_D0plusD0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Re_centbin_pTbin_ybin_massbin*1./HFsumETPlus, HFsumETPlus);
                  hist_Q2Q2_D0plusD0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0HF_Im_centbin_pTbin_ybin_massbin*1./HFsumETPlus, HFsumETPlus);
                  ...
                  hist_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)), HFsumETMinus*HFsumETPlus*(HFsumETPlus-1));
                  hist_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)), HFsumETMinus*HFsumETPlus*(HFsumETPlus-1));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)), HFsumETMinus*HFsumETPlus*(HFsumETPlus-1));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0HFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)), HFsumETMinus*HFsumETPlus*(HFsumETPlus-1));   
                ...
                if(y[i]>0){
                  ...
                  hist_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin*1./HFsumETMinus, HFsumETMinus);
                  hist_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin*1./HFsumETMinus, HFsumETMinus);
                  hist_Q2Q2_D0plusD0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin*1./HFsumETMinus, HFsumETMinus);
                  hist_Q2Q2_D0plusD0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin*1./HFsumETMinus, HFsumETMinus);
                  ...
                  hist_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)), HFsumETPlus*HFsumETMinus*(HFsumETMinus-1));
                  hist_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)), HFsumETPlus*HFsumETMinus*(HFsumETMinus-1));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)), HFsumETPlus*HFsumETMinus*(HFsumETMinus-1));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETPlus*HFsumETMinus*(HFsumETMinus-1)), HFsumETPlus*HFsumETMinus*(HFsumETMinus-1));   
                  ...
                  hist_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin*1./HFsumETPlus, HFsumETPlus);
                  hist_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin*1./HFsumETPlus, HFsumETPlus);
                  hist_Q2Q2_D0plusD0barHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Re_centbin_pTbin_ybin_massbin*1./HFsumETPlus, HFsumETPlus);       
                  hist_Q2Q2_D0plusD0barHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2_D0barHF_Im_centbin_pTbin_ybin_massbin*1./HFsumETPlus, HFsumETPlus);
                  ...
                  hist_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)), HFsumETMinus*HFsumETPlus*(HFsumETPlus-1));
                  hist_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)), HFsumETMinus*HFsumETPlus*(HFsumETPlus-1));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Re_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Re_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)), HFsumETMinus*HFsumETPlus*(HFsumETPlus-1));
                  hist_Q2Q2Q2Q2_D0plusD0barHFHFHF_Im_centbin_pTbin_ybin_massbin[i_centbin][i_pTbin][i_ybin]->Fill(mass[i],aux_Q2Q2Q2Q2_D0barHFHFHF_Im_centbin_pTbin_ybin_massbin*1./(HFsumETMinus*HFsumETPlus*(HFsumETPlus-1)), HFsumETMinus*HFsumETPlus*(HFsumETPlus-1));   
