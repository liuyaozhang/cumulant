...
void massfitvn_combine_3fit_Cesar_D0plusD0bar_pTbins_version2(Bool_t isV2 = false, Bool_t isV2_2SubEvt = true, Bool_t isV3 = false, Bool_t isV1 = false, Bool_t isV1_MixH = false, Bool_t isV24 = false, TString label_ybin = "y-1.0to1.0",TString label2_ybin = "abseta0T1", TString range_ybin = "|y|<1", TString label_centbin = "cent0to10", TString range_centbin = "cent. 0-10%", TString folderForPlots = "f_update_weight", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=false)
{
