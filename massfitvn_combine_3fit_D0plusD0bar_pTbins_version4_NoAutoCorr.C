...
//tracker:
//|y|<1
//void massfitvn_combine_3fit_D0plusD0bar_pTbins_version4_NoAutoCorr(Bool_t isV24tracker = true, Bool_t isV24HF = false, TString label_ybin = "y-1.0to1.0",TString label2_ybin = "abseta1T1", TString range_ybin = "|y|<1", TString label_centbin = "cent10to50", TString range_centbin = "cent. 10-50%", TString folderForPlots = "f_update_build15_ExactCumulant_tracker_NoAutoCorr_denominator_HaveAutoCorr", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=false)
//1<|y|<2
//void massfitvn_combine_3fit_D0plusD0bar_pTbins_version4_NoAutoCorr(Bool_t isV24tracker = true, Bool_t isV24HF = false, TString label_ybin = "y1.0to2.0",TString label2_ybin = "abseta1T2", TString range_ybin = "1<|y|<2", TString label_centbin = "cent10to50", TString range_centbin = "cent. 10-50%", TString folderForPlots = "f_update_build15_ExactCumulant_tracker_NoAutoCorr_denominator_HaveAutoCorr", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=true)

//HF
//|y|<1
void massfitvn_combine_3fit_D0plusD0bar_pTbins_version4_NoAutoCorr(Bool_t isV24tracker = false, Bool_t isV24HF = true, TString label_ybin = "y-1.0to1.0",TString label2_ybin = "abseta1T1", TString range_ybin = "|y|<1", TString label_centbin = "cent10to50", TString range_centbin = "cent. 10-50%", TString folderForPlots = "f_update_build15_ExactCumulant_HF_NoAutoCorr_denominator_HaveAutoCorr_test", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=false)
//1<|y|<2
//void massfitvn_combine_3fit_D0plusD0bar_pTbins_version4_NoAutoCorr(Bool_t isV24tracker = false, Bool_t isV24HF = true, TString label_ybin = "y1.0to2.0",TString label2_ybin = "abseta1T2", TString range_ybin = "1<|y|<2", TString label_centbin = "cent10to50", TString range_centbin = "cent. 10-50%", TString folderForPlots = "f_update_build15_ExactCumulant_HF_NoAutoCorr_denominator_HaveAutoCorr", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=true)

{
    ...
    TFile* file0 = TFile::Open("/afs/cern.ch/user/z/zhangli/public_work/Scalar-product/MC/histograms_3Dcuts_build15_ExactCumulant_cen10T50.root");
    //TFile* file1 = TFile::Open("/afs/cern.ch/user/z/zhangli/public_work/Scalar-product/batch/test_5000bins.root");
    TFile* file1 = TFile::Open("/afs/cern.ch/user/z/zhangli/public_work/Scalar-product/batch/TestOutPutDir/PbPbMB.ExactCumulant_total.root");
    ...
    //double momentumbin[2]= {2.0, 100.};
    //double pTbin[1]={51.0};
    double pTbinwidth[10]={0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 1.5, 2.5, 7.5, 35.0};
	...
	h_data->GetFunction(Form("f_%d",i))->SetBit(TF1::kNotDraw); //cesar
        ...
        if(isV24tracker){
          TH1D* hQ2Q2Q2Q2_TrkmTrkmTrkpTrkp = (TH1D*)file1->Get("Q2Q2Q2Q2_TrkmTrkmTrkpTrkp_Re_"+label_centbin);
          TH1D* h_product_4Q2 = (TH1D*) hQ2Q2Q2Q2_TrkmTrkmTrkpTrkp->Clone("h_product_4Q2");
          TH1D* hQ2Q2Q4_TrkmTrkmTrkp = (TH1D*)file1->Get("Q2Q2Q4_TrkmTrkmTrkp_Re_"+label_centbin);
          TH1D* hQ4Q2Q2_TrkmTrkpTrkp = (TH1D*)file1->Get("Q4Q2Q2_TrkmTrkpTrkp_Re_"+label_centbin);
          TH1D* hQ4Q4_TrkmTrkp = (TH1D*)file1->Get("Q4Q4_TrkmTrkp_Re_"+label_centbin);
          TH1D* hQ2Q2_TrkmTrkp = (TH1D*)file1->Get("Q2Q2_TrkmTrkp_Re_"+label_centbin);
          
          h_product_4Q2->Add(hQ4Q4_TrkmTrkp);
          h_product_4Q2->Add(hQ2Q2Q4_TrkmTrkmTrkp, -1);
          h_product_4Q2->Add(hQ4Q2Q2_TrkmTrkpTrkp, -1);
          ...
          TH1D* hQ2Q2Q4_HFmHFmHFp = (TH1D*)file1->Get("Q2Q2Q4_HFmHFmHFp_Re_"+label_centbin);
          TH1D* hQ4Q2Q2_HFmHFpHFp = (TH1D*)file1->Get("Q4Q2Q2_HFmHFpHFp_Re_"+label_centbin);
          ...
          h_product_4Q2->Add(hQ4Q4_HFmHFp);
          h_product_4Q2->Add(hQ2Q2Q4_HFmHFmHFp, -1);
          h_product_4Q2->Add(hQ4Q2Q2_HFmHFpHFp, -1);
        ...
        TH1D *hvn_data_Q2Q2;
        if(isV24tracker){
          TH2D* hQ2Q2Q2Q2_D0plusD0barTrkTrkTrk = (TH2D*)file1->Get("hist_Q2Q2Q2Q2_D0plusD0barTrkTrkTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_"+label_ybin);
          TH2D* hQ2Q2_D0plusD0barTrk = (TH2D*)file1->Get("hist_Q2Q2_D0plusD0barTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_"+label_ybin);
          TH2D* hQ2Q2Q4_D0plusD0barTrkTrk = (TH2D*)file1->Get("hist_Q2Q2Q4_D0plusD0barTrkTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_"+label_ybin);
          
          if(isForward){
            TH2D* aux_hQ2Q2Q2Q2_D0plusD0barTrkTrkTrk = (TH2D*)file1->Get("hist_Q2Q2Q2Q2_D0plusD0barTrkTrkTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_y-2.0to-1.0");
            TH2D* aux_hQ2Q2Q4_D0plusD0barTrkTrk = (TH2D*)file1->Get("hist_Q2Q2Q4_D0plusD0barTrkTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_y-2.0to-1.0");
            TH2D* aux_hQ2Q2_D0plusD0barTrk = (TH2D*)file1->Get("hist_Q2Q2_D0plusD0barTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_y-2.0to-1.0");
            hQ2Q2Q2Q2_D0plusD0barTrkTrkTrk->Sumw2();
            hQ2Q2Q2Q2_D0plusD0barTrkTrkTrk->Add(aux_hQ2Q2Q2Q2_D0plusD0barTrkTrkTrk);
             
            hQ2Q2Q4_D0plusD0barTrkTrk->Sumw2();
            hQ2Q2Q4_D0plusD0barTrkTrk->Add(aux_hQ2Q2Q4_D0plusD0barTrkTrk);
          ...
          hproduct_4D0plusD0bar->Add(hQ2Q2Q4_D0plusD0barTrkTrk, -1);
          TProfile* tpQ2Q2Q2Q2_D0plusD0barTrkTrkTrk = (TProfile*)hproduct_4D0plusD0bar->ProfileX("tpQ2Q2Q2Q2_D0plusD0barTrkTrkTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_"+label_ybin,1,-1,"i");
	  vn_data = tpQ2Q2Q2Q2_D0plusD0barTrkTrkTrk->ProjectionX("");
	  TProfile* tpQ2Q2_D0plusD0barTrk = (TProfile *)hQ2Q2_D0plusD0barTrk->ProfileX("tpQ2Q2_D0plusD0barTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_"+label_ybin,1,-1,"i");
	  TH1D *hQ2Q2_TrkmTrkp = (TH1D*)file1->Get("Q2Q2_TrkmTrkp_Re_"+label_centbin);
	  ...
	  vn_data->Scale(-1.0/vn_den);
          ...
          TH2D* hQ2Q2Q4_D0plusD0barHFHF = (TH2D*)file1->Get("hist_Q2Q2Q4_D0plusD0barHFHF_Re_"+label_centbin+"_"+label_pTbin[i]+"_"+label_ybin);
          ...
          if(isForward){//should also include negative side, since in script can only use one side ...
            ...
            TH2D* aux_hQ2Q2Q4_D0plusD0barHFHF = (TH2D*)file1->Get("hist_Q2Q2Q4_D0plusD0barHFHFHF_Re_"+label_centbin+"_"+label_pTbin[i]+"_y-2.0to-1.0"); 
            ...
            hQ2Q2Q4_D0plusD0barHFHF->Sumw2();
            hQ2Q2Q4_D0plusD0barHFHF->Add(aux_hQ2Q2Q4_D0plusD0barHFHF);
          ...
          hproduct_4D0plusD0bar->Add(hQ2Q2Q4_D0plusD0barHFHF, -1);
          TProfile* tpQ2Q2Q2Q2_D0plusD0barHFHFHF = (TProfile*)hproduct_4D0plusD0bar->ProfileX("tpQ2Q2Q2Q2_D0plusD0barHFHFHF_Re_"+label_centbin+"_"+label_pTbin[i]+"_"+label_ybin,1,-1,"i");
