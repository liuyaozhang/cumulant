...
//tracker:
//|y|<1
//void massfitvn_combine_3fit_D0plusD0bar_pTbins_version4_HaveAutoCorr(Bool_t isV24tracker = true, Bool_t isV24HF = false, TString label_ybin = "y-1.0to1.0",TString label2_ybin = "abseta1T1", TString range_ybin = "|y|<1", TString label_centbin = "cent10to50", TString range_centbin = "cent. 10-50%", TString folderForPlots = "f_update_build15_ExactCumulant_tracker_HaveAutoCorr", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=false)
//1<|y|<2
//void massfitvn_combine_3fit_D0plusD0bar_pTbins_version4_HaveAutoCorr(Bool_t isV24tracker = true, Bool_t isV24HF = false, TString label_ybin = "y1.0to2.0",TString label2_ybin = "abseta1T2", TString range_ybin = "1<|y|<2", TString label_centbin = "cent10to50", TString range_centbin = "cent. 10-50%", TString folderForPlots = "f_update_build15_ExactCumulant_tracker_HaveAutoCorr", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=true)

//HF
//|y|<1
void massfitvn_combine_3fit_D0plusD0bar_pTbins_version4_HaveAutoCorr(Bool_t isV24tracker = false, Bool_t isV24HF = true, TString label_ybin = "y-1.0to1.0",TString label2_ybin = "abseta1T1", TString range_ybin = "|y|<1", TString label_centbin = "cent10to50", TString range_centbin = "cent. 10-50%", TString folderForPlots = "f_update_build15_ExactCumulant_HF_HaveAutoCorr_test", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=false)
//1<|y|<2
//void massfitvn_combine_3fit_D0plusD0bar_pTbins_version4_HaveAutoCorr(Bool_t isV24tracker = false, Bool_t isV24HF = true, TString label_ybin = "y1.0to2.0",TString label2_ybin = "abseta1T2", TString range_ybin = "1<|y|<2", TString label_centbin = "cent10to50", TString range_centbin = "cent. 10-50%", TString folderForPlots = "f_update_build15_ExactCumulant_HF_HaveAutoCorr", Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=true)

{
    ...
    TFile* file1 = TFile::Open("/afs/cern.ch/user/z/zhangli/public_work/Scalar-product/batch/test_200bins.root");
	...
	h_data->GetFunction(Form("f_%d",i))->SetBit(TF1::kNotDraw); //cesar
        ...
        if(isV24tracker){
          ...
          Double_t aux_Q2Q2Q2Q2_TrkmTrkmTrkpTrkp_mean = hQ2Q2Q2Q2_TrkmTrkmTrkpTrkp->GetMean();
        ...
        if(isV24tracker){
          ...
          TProfile* tpQ2Q2Q2Q2_D0plusD0barTrkTrkTrk = (TProfile*)hQ2Q2Q2Q2_D0plusD0barTrkTrkTrk->ProfileX("tpQ2Q2Q2Q2_D0plusD0barTrkTrkTrk_Re_"+label_centbin+"_"+label_pTbin[i]+"_"+label_ybin,1,-1,"i");
    ...
    for(int i=0;i<n_pTbin;i++)
    {
        //c1[i]->Print(Form(folder_plots+label2_ybin+"_%d.pdf",i));//liuyao
    }
    ...
    leg_vnplot->Draw();
    //c3->Print(folder_plots+label2_ybin+"_Vn.pdf");//liuyao
