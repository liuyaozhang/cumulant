...
TString folderForPlots = "../f_update_build17_ExactCumulant_"+detector[number_detector]+"_NoAutoCorr_update_Jun30/v2_vs_pT/systematic_uncertainty/mass_bkg/95percent_data_default_8pTbins_centralitytable_2nd_poly_bkg";

void massfitvn_combine_3fit_D0plusD0bar_pTbins_version5_NoAutoCorr_differential_pT_mass_2th_poly_bkg(Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=false)
{
