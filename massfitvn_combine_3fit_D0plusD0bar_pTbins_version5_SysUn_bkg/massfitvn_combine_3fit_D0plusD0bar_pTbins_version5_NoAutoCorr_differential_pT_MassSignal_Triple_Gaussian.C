...
void massfitvn_combine_3fit_D0plusD0bar_pTbins_version5_NoAutoCorr_differential_pT_MassSignal_Triple_Gaussian(Double_t vnYrangeMin = -0.2, Double_t vnYrangeMax = 0.6, Bool_t isForward=false)
{
   ...
   isV24HF=true;
    ...
    for(int i=0;i<pTPoints;i++)
    {
	 ...
	 if(isForward){
	  ...
	  if(isForward){
        ...
        //Mass Signal: DoubleGaussian -> TripleGaussian
        //Sep29, 2020
	TF1* f = new TF1(Form("f_%d",i),"[0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6])) + [14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6])) + (1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6])))+(1-[5])*TMath::Gaus(x,[8],[7]*(1.0 +[6]))/(sqrt(2*3.14159)*[7]*(1.0 +[6]))) + [9] + [10]*x + [11]*x*x + [12]*x*x*x", fit_range_low, fit_range_high);
	...
	h_data->GetFunction(Form("f_%d",i))->SetBit(TF1::kNotDraw); //cesar
        ...
        TF1* f1 = new TF1(Form("f_sig_%d",i),"[0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6])) + [14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6])) + (1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6]))))", fit_range_low, fit_range_high);
	...
	TF1* fmass_combinemassvnfit = new TF1(Form("fmass_combinemassvnfit_%d",i),"[0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6]))+ [14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6])) +(1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6])))+(1-[5])*TMath::Gaus(x,[8],[7]*(1.0 +[6]))/(sqrt(2*3.14159)*[7]*(1.0 +[6]))) + [9] + [10]*x + [11]*x*x + [12]*x*x*x", fit_range_low, fit_range_high);
        

        TF1* fvn_combinemassvnfit = new TF1(Form("fvn_combinemassvnfit_%d",i),"[15]*( (([0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6]))+[14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6]))+(1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6]))))) + ([0]*((1-[5])*TMath::Gaus(x,[8],[7]*(1.0 +[6]))/(sqrt(2*3.14159)*[7]*(1.0 +[6])))))/([0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6]))+[14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6]))+(1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6])))+(1-[5])*TMath::Gaus(x,[8],[7]*(1.0 +[6]))/(sqrt(2*3.14159)*[7]*(1.0 +[6]))) + [9] + [10]*x + [11]*x*x + [12]*x*x*x) ) + (1 - (([0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6]))+[14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6]))+(1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6]))))) + ([0]*((1-[5])*TMath::Gaus(x,[8],[7]*(1.0 +[6]))/(sqrt(2*3.14159)*[7]*(1.0 +[6])))))/([0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6]))+[14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6]))+(1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6])))+(1-[5])*TMath::Gaus(x,[8],[7]*(1.0 +[6]))/(sqrt(2*3.14159)*[7]*(1.0 +[6]))) + [9] + [10]*x + [11]*x*x + [12]*x*x*x) )*( [16] + [17] * x )");//[15] is vn
	...
	const int Npar = 18; 
        ...
        vn[i] = fvn_combinemassvnfit->GetParameter(15); 
        vne[i] = fvn_combinemassvnfit->GetParError(15);
        ...
        TF1* falpha = new TF1(Form("falpha_%d",i),"( [0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6])) +[14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6])) + (1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6])))+(1-[5])*TMath::Gaus(x,[8],[7]*(1.0 +[6]))/(sqrt(2*3.14159)*[7]*(1.0 +[6]))) )/( [0]*([5]*([4]*TMath::Gaus(x,[1],[2]*(1.0 +[6]))/(sqrt(2*3.14159)*[2]*(1.0 +[6]))+[14]*TMath::Gaus(x,[1],[13]*(1.0 +[6]))/(sqrt(2*3.14159)*[13]*(1.0 +[6])) +(1-[4]-[14])*TMath::Gaus(x,[1],[3]*(1.0 +[6]))/(sqrt(2*3.14159)*[3]*(1.0 +[6])))+(1-[5])*TMath::Gaus(x,[8],[7]*(1.0 +[6]))/(sqrt(2*3.14159)*[7]*(1.0 +[6]))) + [9] + [10]*x + [11]*x*x + [12]*x*x*x )", fit_range_low,fit_range_high);
